    ...
    <div className='flex justify-center w-full '>
        <div  className='w-[90%]'>
            <div className='text-[#344054]'>
                <div className='text-[#344054] text-[24px] font-bold mb-[8px] mt-[64px] '>Welcome Back Alexander,</div>
                ...
                <div className='mt-[20px] grid grid-cols-3 '>
                    <div className='admingrid w-[254px] h-[188px] text-[#344054] py-[24px] pl-[24px] '>
                        ...
                        <div className='text-[32px] font-semibold leading-[43.8px] -tracking-[0.8px] ' >345</div>
                    </div>
                    <div className='admingrid w-[254px] h-[188px] text-[#344054] py-[24px] pl-[24px] '>
                        <Image src={registered} alt='registered' className='mb-[16px] ' />
                        <div  className='text-[16px] leading-[24px] mb-[8px] '>Total Registered</div>
                        <div className='text-[32px] font-semibold leading-[43.8px] -tracking-[0.8px] ' >189</div>
                    </div>
                    <div className='admingrid w-[254px] h-[188px] text-[#344054] py-[24px] pl-[24px] '>
